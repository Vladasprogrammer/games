...
var Create = /*#__PURE__*/function (_Request) {
  function Create(Page) {
    ...
    _this = _callSuper(this, Create, [Page.page]);
...
var Delete = /*#__PURE__*/function (_Request) {
  function Delete(Page) {
    ...
    _this = _callSuper(this, Delete, [Page.page]);
    _this.Page = Page;
    _this.form = document.querySelector('[data-form=delete]');
    _this.modal = document.querySelector('[data-modal=delete]');
  ...
  return _createClass(Delete, [{
    ...
    value: function showModal(item) {
      ...
      keys.forEach(function (key) {
        if (_this2.form.querySelector("[data-key=".concat(key, "]"))) {
          _this2.form.querySelector("[data-key=".concat(key, "]")).innerText = item[key];
        }
      });
...
var Edit = /*#__PURE__*/function (_Request) {
  function Edit(Page) {
    ...
    _this = _callSuper(this, Edit, [Page.page]);
    _this.Page = Page;
    _this.form = document.querySelector('[data-form=edit]');
    _this.modal = document.querySelector('[data-modal=edit]');
    _this.modal.querySelectorAll('[data-type="cancel"]').forEach(function (button) {
      button.addEventListener('click', _this.hideModal.bind(_this));
    });
    _this.form.querySelector('[data-type=submit]').addEventListener('click', _this.submitEdit.bind(_this));
    return _this;
  }
  ...
  return _createClass(Edit, [{
    ...
    value: function showModal(item) {
      ...
      var keys = Object.keys(item); //[id, title, ...]
      keys.forEach(function (key) {
        if (_this2.form.querySelector("[name=".concat(key, "]"))) {
          var i = _this2.form.querySelector("[name=".concat(key, "]"));
...
var Game = /*#__PURE__*/function () {
  function Game() {
    ...
    new _Select_js__WEBPACK_IMPORTED_MODULE_4__["default"]('genres', 'data-select-genres', 'genre_id');
  }
...
var Messages = /*#__PURE__*/function () {
  ...
  return _createClass(Messages, null, [{
    key: "addMessage",
    value: function addMessage(response) {
      var _response$data,
        _this = this;
      if (!((_response$data = response.data) !== null && _response$data !== void 0 && _response$data.msg)) {
        return;
      }
      var msg = {
    ...
    value: function renderMessages() {
      var _this2 = this;
      var bin = document.querySelector('[data-msg-bin]');
      bin.innerHTML = '';
      this.msgs.forEach(function (msg) {
        var div = document.createElement('div');
        div.classList.add('alert', 'alert-dismissible', "alert-".concat(msg.type));
...
var Read = /*#__PURE__*/function (_Request) {
  function Read(Page) {
    ...
    _this = _callSuper(this, Read, [Page.page]);
  ...
  return _createClass(Read, [{
    ...
    value: function render(response) {
      ...
      response.data.forEach(function (item) {
        ...
        var editButton = clone.querySelector('[data-button-type=edit]');
        editButton.addEventListener('click', function (_) {
          _this2.Page.Edit.showModal(item);
        });
        var deleteButton = clone.querySelector('[data-button-type=delete]');
        deleteButton.addEventListener('click', function (_) {
          _this2.Page.Delete.showModal(item);
        });
...
var Request = /*#__PURE__*/function () {
  ...
  return _createClass(Request, [{
    key: "edit",
    value: function edit(data, id) {
      var _this = this;
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].put(this.url + '/' + id, data).then(function (res) {
        _this.response(res);
        _Messages__WEBPACK_IMPORTED_MODULE_0__["default"].addMessage(res);
      })["catch"](function (err) {
        console.log(err);
      });
    }
    ...
    value: function create(data) {
      var _this2 = this;
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].post(this.url, data).then(function (res) {
        _this2.response(res);
        _Messages__WEBPACK_IMPORTED_MODULE_0__["default"].addMessage(res);
      })["catch"](function (err) {
        console.log(err);
        _Messages__WEBPACK_IMPORTED_MODULE_0__["default"].addMessage(err === null || err === void 0 ? void 0 : err.response);
      });
    }
  }, {
    key: "delete",
    value: function _delete(id) {
      var _this3 = this;
      axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"](this.url + '/' + id).then(function (res) {
        _this3.response(res);
        _Messages__WEBPACK_IMPORTED_MODULE_0__["default"].addMessage(res);
      })["catch"](function (err) {
        console.log(err);
    ...
    value: function read() {
      var _this4 = this;
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(this.url).then(function (res) {
        _this4.response(res);
      })["catch"](function (err) {
        console.log(err);
      });
...
var Select = /*#__PURE__*/function (_Request) {
  function Select(page, dataSelector, selectName) {
    var _this;
    _classCallCheck(this, Select);
    _this = _callSuper(this, Select, [page]);
    _this.dataSelector = dataSelector;
    _this.selectName = selectName;
    _this.read();
    return _this;
  }
  ...
  return _createClass(Select, [{
    key: "renderSelect",
    value: function renderSelect(data) {
      var _this2 = this;
      var selects = document.querySelectorAll("[".concat(this.dataSelector, "]"));
      selects.forEach(function (select) {
        var s = document.createElement('select');
        s.classList.add('form-select');
        s.name = _this2.selectName;
    ...
    key: "response",
    value: function response(_response) {
      this.renderSelect(_response.data);
    }
  }]);
}(_Request_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
